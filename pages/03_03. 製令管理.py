...
with tab1:
    ...
    sort_editor_state(STATE_KEY, "work_orders")
    ...
    edited = st.data_editor(
        ...
        key="work_orders_data_editor_v117",
    )
...
with tab3:
    ...
    if raw.strip():
        ...
        if parsed.empty:
            ...
            if a2.button("💾 直接儲存貼上資料 / Save Pasted Work Orders", type="primary", use_container_width=True, key="save_pasted_work_orders_v117"):
