...
CONFIG_PATH = PROJECT_ROOT / "data" / "config" / "history_filter_settings.json"
STATE_PATH = PROJECT_ROOT / "data" / "persistent_state" / "spt_history_filter_settings.json"
MODULE_PATH = PROJECT_ROOT / "data" / "persistent_modules" / "02_history" / "history_filter_settings.json"
