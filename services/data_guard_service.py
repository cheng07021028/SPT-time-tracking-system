...
def _employee_sources() -> list[Path]:
    ...
    latest = _latest_file([
        "data/persistent_modules/04_employees/history/*employees*records*.json",
        "data/persistent_state/history/spt_permanent_state_*.json",
        "data/persistent_state/archive/spt_permanent_state_*.json",
    ])
    if latest:
...
def _work_order_sources() -> list[Path]:
    ...
    latest = _latest_file([
        "data/persistent_modules/03_work_orders/history/*work_orders*records*.json",
        "data/persistent_state/history/spt_permanent_state_*.json",
        "data/persistent_state/archive/spt_permanent_state_*.json",
    ])
    if latest:
