...
CONFIG_PATH = PROJECT_ROOT / "data" / "config" / "analysis_filter_settings.json"
STATE_PATH = PROJECT_ROOT / "data" / "persistent_state" / "spt_analysis_filter_settings.json"
MODULE_PATH = PROJECT_ROOT / "data" / "persistent_modules" / "05_analysis" / "analysis_filter_settings.json"
