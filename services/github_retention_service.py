...
CONFIG_PATH = PROJECT_ROOT / "data" / "config" / "github_cleanup_settings.json"
STATE_PATH = PROJECT_ROOT / "data" / "persistent_state" / "spt_github_cleanup_state.json"
AUDIT_PATH = PROJECT_ROOT / "data" / "persistent_state" / "spt_github_module_backup_audit.json"

REMOTE_MODULE_ROOT = "data/persistent_modules"
REMOTE_STATE_ROOT = "data/persistent_state"
REMOTE_ALLOWED_ROOTS = [
    "data/persistent_modules",
    "data/persistent_state/history",
    "data/persistent_state/audit_history",
...
DEFAULT_CLEANUP_SETTINGS = {
    ...
    "frequency": "weekly",
    "keep_days": 90,
    "roots": ["data/persistent_state/history", "data/persistent_state/audit_history", "data/persistent_modules"],
