...
1. Write settings to data/config, data/persistent_state, and data/persistent_modules.
...
CRITICAL_SETTING_FILES: list[dict[str, str]] = [
    {"label": "13 system settings primary", "path": "data/config/system_settings.json"},
    {"label": "13 system settings state", "path": "data/persistent_state/spt_system_settings.json"},
    {"label": "13 system settings module", "path": "data/persistent_modules/13_system_settings/system_settings.json"},
    {"label": "daily backup schedule", "path": "data/config/auto_external_backup_schedule.json"},
    {"label": "daily backup state", "path": "data/persistent_state/auto_external_backup_state.json"},
    {"label": "security settings primary", "path": "data/config/security_settings.json"},
    {"label": "security settings state", "path": "data/persistent_state/spt_security_settings.json"},
