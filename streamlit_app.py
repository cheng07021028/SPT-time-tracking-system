...
apply_theme()
require_login("home")
# V255: Do not start Neon/PostgreSQL authority bootstrap on home/login rerun.
# Heavy import/bootstrap must be triggered from maintenance or 01/02 pages only.
