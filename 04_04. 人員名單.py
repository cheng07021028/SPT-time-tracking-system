...
with tab1:
    ...
    edited = st.data_editor(
        ...
        key="employees_data_editor_v116",
    )
...
with tab3:
    ...
    raw = st.text_area("貼上 Excel 複製資料", height=260, key="employees_paste_raw_v116")
    ...
    if raw.strip():
        ...
        if parsed.empty:
            ...
            a1, a2 = st.columns(2)
            if a1.button("➕ 加入清單編輯 / Add to Editor", type="secondary", use_container_width=True, key="add_pasted_employees_to_editor_v116"):
            ...
            if a2.button("💾 直接儲存貼上資料 / Save Pasted Employees", type="primary", use_container_width=True, key="save_pasted_employees_v116"):
