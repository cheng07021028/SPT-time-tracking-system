...
# V62: home/login hot path does not bootstrap local permanent_store.
# Neon/PostgreSQL remains the runtime authority; backup/restore stays manual in module 09/14.
