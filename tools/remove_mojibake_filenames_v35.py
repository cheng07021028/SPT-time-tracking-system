# -*- coding: utf-8 -*-
"""V35: remove #Uxxxx / mojibake Streamlit page files after normal Chinese files are added.

Run from project root:
    python tools/remove_mojibake_filenames_v35.py
